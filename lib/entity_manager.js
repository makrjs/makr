...
var Storage = require("./contiguous_storage")
...
function EntityManager() {
  ...
  // Components storages
  this._components = new Components(Cs)
  this._storage = new Storage(this._components, INITIAL_CAPACITY)
...
EntityManager.prototype._mask = function(id) {
  return this._entityMask[id]
}
